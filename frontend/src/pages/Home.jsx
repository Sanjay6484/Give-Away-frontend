...
const Home = () => {
  return (
    <div className='w-full '>
          <div className='text-white py-14 px-5 flex flex-col items-center text-center'>
          <h1 className=' font-bold text-2xl '>Want Free Stuff ?</h1>
           <p className='font-bold'>Got stuff to give away?</p>
           <p className=' text-sm text-gray-400 pt-4'>🌍Empower change, embrace sustainability every EcoSwap makes a difference.♻️</p>
          </div>
